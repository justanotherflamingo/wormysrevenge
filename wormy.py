        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                if (event.key == K_LEFT or event.key == K_a):
                    directionChangeBufferQueue.append(LEFT)
                elif (event.key == K_RIGHT or event.key == K_d):
                    directionChangeBufferQueue.append(RIGHT)
                elif (event.key == K_UP or event.key == K_w):
                    directionChangeBufferQueue.append(UP)
                elif (event.key == K_DOWN or event.key == K_s):
                    directionChangeBufferQueue.append(DOWN)
                elif event.key == K_ESCAPE:
                    terminate()
        
        if len(directionChangeBufferQueue):
            newDirection = directionChangeBufferQueue.pop(0)
